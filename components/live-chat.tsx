  ...
  const sendMessage = () => {
    ...
    setTimeout(() => {
      const botResponse = {
        ...
        text: "Thanks for your message! Our team will get back to you shortly. For immediate assistance, please call +91 98765 43210 or book directly via WhatsApp.",
        sender: "bot",
        timestamp: new Date(),
      }
            ...
            <div key={message.id} className={`flex ${message.sender === "user" ? "justify-end" : "justify-start"}`}>
              <div
                className={`max-w-[80%] p-3 rounded-lg ${
                  message.sender === "user" ? "bg-blue-500 text-white" : "bg-gray-100 dark:bg-gray-800 text-foreground"
                }`}
              >
