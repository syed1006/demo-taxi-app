...
const slides = [
	{
		...
		background: "/assets/bg/city-bg.png",
	...
	},
	{
		...
		background: "/assets/bg/airplane.png",
	...
	},
	{
		...
		cta: "Plan Your Trip",
		background: "/assets/bg/mountain.png",
	...
	},
	{
		...
		background: "/assets/bg/corporate.jpg",
				...
				<div className="space-y-6 sm:space-y-8">
					...
					<div className="space-y-3 sm:space-y-4">
						<h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold text-white leading-tight">
							...
							<span className="block text-orange-300 animate-slide-in-right">
